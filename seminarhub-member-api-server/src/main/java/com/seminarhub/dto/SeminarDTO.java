 ...
 * Description: Data Transfer Object (DTO) class for representing Seminar information.
 * This class holds details related to seminars, such as their names and explanations.
 */
@Data
@Builder
@AllArgsConstructor
